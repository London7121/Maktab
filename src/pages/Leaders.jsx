                ...
                <div className='w-auto mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
                    {loading ? (
                        ...
                        leaders?.leaders.map((news, index) => (
                            ...
                            >
                                <Image style={{ objectFit: 'cover' }} width={"100%"} height={400} src={news.image} alt={news.title} className='object-cover rounded' />
                                <div className='py-3'>
                ...
                <div className='w-auto mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
                    {loading ? (
                        ...
                        leaders?.addel_kadrs.map((news, index) => (
                            ...
                            >
                                <Image style={{ objectFit: 'cover' }} width={"100%"} height={380} src={news.image} alt={news.title} className='object-cover rounded' />
