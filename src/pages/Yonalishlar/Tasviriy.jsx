...
export default function Tasviriy() {
    ...
    return (
        <div className="container mx-auto p-4">
            <h1 className="text-2xl md:text-3xl font-bold md:my-10 text-[#6e54d8]">{t("tasvir")}</h1>
                ...
                <div className="flex flex-wrap items-center justify-center lg:flex-nowrap bg-white p-6 shadow-lg rounded-lg">
                    ...
                    <div className="w-full lg:w-1/2 pr-4">
                        <table className="w-full border-collapse border border-gray-300">
                            ...
                            <tbody>
                                {arxitektura.documentsTasviriy.map((doc, index) => (
                    ...
                    <div className="w-full lg:w-1/2 overflow-hidden relative py-2">
                        <Marquee gradient={false} speed={100}>
                            {arxitektura.documentsArx.map((doc, index) => (
                                <img
                                    key={index}
                                    src={`/images/arxitektura/${index + 1}.jpg`}
