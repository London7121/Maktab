    ...
    return (
        <div className='max-w-[1380px] mx-auto p-4 mt-1 font-afacad'>
            <div className='flex flex-row items-start lg:items-start gap-6'>
                {/* Chap tarafdagi rasm */}
                <div className='w-[100%] md:w-[30%] flex flex-col sm:flex-row items-center justify-center'>
                    {loading ? (
                        <Skeleton.Image className='w-[300px] h-[200px]' active />
                    ) : (
                        <Image
                            src={directors?.manaviy.image}
                            alt={directors?.manaviy.title[i18n.language]}
                            width="100%"
                            height="auto"
                ...
                <div className='w-full lg:w-1/2'>
                    <h1 className='text-md text-start sm:text-xl font-bold text-[#2b82fc] lg:text-left'>
                        {directors?.manaviy.title[i18n.language]}
                    </h1>
                    <p className='text-base text-start sm:text-lg mt-4'>
                        {directors?.manaviy.description[i18n.language]}
                    </p>
                </div>
            </div>
        </div>
