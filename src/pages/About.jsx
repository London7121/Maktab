  ...
  return (
    <div className="text-center sm:my-10 border-b pb-4 bg-[#f9f7f7] font-afacad">
      ...
      <div className="w-full h-auto p-2 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 items-center justify-between gap-4">
        <div className="flex flex-col items-center border border-red-200 rounded-md w-auto h-auto p-2 shadow-sm duration-150 hover:scale-105 hover:duration-150 hover:shadow-lg">
          <CountUp
            ...
            direction="up"
            duration={1}
            className="count-up-text text-[40px] font-afacad font-medium text-red-500"
          />
          <p className="text-xl sm:text-2xl text-gray-600 mx-4 text-start">
            ta o'quvchi
          </p>
        </div>
        <div className="flex flex-col items-center border border-green-200  rounded-md w-auto h-auto p-2 shadow-sm duration-150 hover:scale-105 hover:duration-150 hover:shadow-lg">
          <CountUp
            from={0}
            ...
            direction="up"
            duration={1}
            className="count-up-text text-[40px] font-afacad font-medium text-green-500"
          />
          <p className="text-xl sm:text-2xl text-gray-600 mx-4 text-start">
            ta o'qituvchi
          </p>
        </div>
        <div className="flex flex-col items-center border border-blue-200 rounded-md w-auto h-auto p-2 shadow-sm duration-150 hover:scale-105 hover:duration-150 hover:shadow-lg">
          <CountUp
            from={0}
            ...
            direction="up"
            duration={1}
            className="count-up-text text-[40px] font-afacad font-medium text-blue-900"
          />
          <p className="text-xl sm:text-2xl text-gray-600 mx-4 text-start">
            ta sinf
          </p>
        </div>
        <div className="flex flex-col items-center border border-yellow-200 rounded-md w-auto h-auto p-2 shadow-sm duration-150 hover:scale-105 hover:duration-150 hover:shadow-lg">
          <CountUp
            from={0}
            ...
            direction="up"
            duration={1}
            className="count-up-text text-[40px] font-afacad font-medium text-yellow-400"
          />
          <p className="text-xl sm:text-2xl text-gray-600 mx-4 text-start">
            ta fan
          </p>
